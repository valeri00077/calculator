...
ac.addEventListener("click", () => {
    for(let i = 0; i < item.length - 1; i++){
        if(item[i].classList.contains("newclassoperator")){
                item[i].classList.remove("newclassoperator")
            }
        }
    sum2 = ""
    sum = ""
    ...
    operator.addEventListener("click", () => {
        ...
        if(sum !== ""){
            if(!["+", "-", "*", "/", "=", "^", "C", "."].includes(sum.charAt(sum.length - 1))){
                ...
                operator.classList.add("newclassoperator")  
            }
...
function operFunction(){
    ...
    if(sum !== ""){
        if(!["+", "-", "*", "/", "=", "^", "C", "."].includes(sum.charAt(sum.length - 1))){
            sum += clicked
            for(let i = 0; i < item.length - 1; i++){
                if(item[i].textContent === clicked){
                        item[i].classList.add("newclassoperator")
                    }
                }
        }
